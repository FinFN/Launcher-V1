...
public static class ZipArchiveExtensions
{
    public static void ExtractToDirectory(this ZipArchive archive, string destinationDirectoryName, bool overwrite)
    {
        ...
        foreach (ZipArchiveEntry file in archive.Entries)
        {
            ...
            {
                throw new IOException("Yritetään purkaa tiedostoa kohdehakemiston ulkopuolelta. Katso lisätietoja tästä linkistä: https://snyk.io/research/zip-slip-vulnerability");
            }
    ...
    public partial class Library : System.Windows.Controls.Page
    {
        ...
        public async void Launch(string Number)
        {
            try
            {
                ...
                if (GamePath != null) // NONE THE BEST RESPONSE!
                {
                    ...
                    if (File.Exists(System.IO.Path.Combine(GamePath, "FortniteGame\\Binaries\\Win64\\FortniteClient-Win64-Shipping.exe")))
                    {
                        ...
                        foreach (var proc in Process.GetProcessesByName("FlippedEAC"))
                        {
                            ...
                            {
                                MessageBox.Show("FinFN on jo päällä pelipolustasi");
                        ...
                        foreach (var proc in Process.GetProcessesByName("FortniteClient-Win64-Shipping"))
                        {
                            ...
                            {
                                MessageBox.Show("Fortnite on jo käynnissä FinFN:ästä");
                                this.Dispatcher.Invoke(() =>
                                {
                        ...
                        if (!File.Exists(System.IO.Path.Combine(GamePath, "FlippedEAC.exe")))
                        {
                            ...
                            if (File.Exists(System.IO.Path.Combine(GamePath, "FlippedEAC.exe")) && Directory.Exists(System.IO.Path.Combine(GamePath, "EasyAntiCheat")))
                            {
                                ...
                                {
                                    MessageBox.Show("Relaunchaa admin permeil se fixaa tän.");
                                ...
                                {
                                    MessageBox.Show("Eac failas latauksen");
                                    File.Delete(Path.Combine(GamePath, "FlippedEAC.exe"));
                                    DeleteDirectory(Path.Combine(GamePath, "EasyAntiCheat"));
                                    this.Dispatcher.Invoke(() =>
                                    {
                        ...
                        Client.DownloadFile($"https://fentti.xyz/upload/127.dll", Path.Combine(GamePath, "Engine\\Binaries\\ThirdParty\\NVIDIA\\NVaftermath\\Win64", "GFSDK_Aftermath_Lib.x64.dll"));
                        ...
                        {
                            MessageBox.Show("Error tapahtu kun FakeAC:ta koitettiin sammuttaa (älä kiinnitä huomiota)");
                            this.Dispatcher.Invoke(() =>
                            {
                    ...
                    {
                        MessageBox.Show("Sinun pelipolku ei ole valid pelipolku");
                        this.Dispatcher.Invoke(() =>
                        {
                ...
                {
                    MessageBox.Show("Lisää pelipolkusi asetuksissa.");
                    this.Dispatcher.Invoke(() =>
                    {
        ...
        private void CheckBuilds()
        {
            ...
            if (SavedData.ReadValue("Auth", "Build1Path") != null)
            {
                ...
                if (Build1Season.Text == "Season 15")
                {
                    Build1Status.Text = "Truettu";
                }
                else
                {
            ...
            if (SavedData.ReadValue("Auth", "Build2Path") != null)
            {
                ...
                if (Build2Season.Text == "Season 15")
                {
                    Build2Status.Text = "Tuettu";
                }
                else
                {
            ...
            if (SavedData.ReadValue("Auth", "Build3Path") != null)
            {
                ...
                if (Build3Season.Text == "Season 15")
                {
                    Build3Status.Text = "Tuettu";
                }
                else
                {
        ...
        private async void PathClick(object sender, RoutedEventArgs e)
        {
            ...
            if (flag)
            {
                ...
                {
                    System.Windows.MessageBox.Show("Valitun kansion on sisällettävä sekä 'FortniteGame' ja 'Engine'-kansiot.");
                }
            }
            else
            {
