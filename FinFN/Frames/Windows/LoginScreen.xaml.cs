    ...
    public partial class LoginScreen : Window
    {
        ...
        private async void LoginClick(object sender, RoutedEventArgs e)
        {
            ...
            if (response != null)
            {
                if (response != "false")
                {
                    ...
                    try
                    {
                        ...
                        if (discordCallbackId.Trim('"') == savedDiscordId)
                        {
                            ...
                            ValidMSG.Text = "Kirjauduttu, ladataan assetit...";
                        ...
                        else
                        {
                            ...
                            ErrorMSG.Text = "Error: Olet bännätty.";
                    ...
                    {
                        ErrorBox.Visibility = Visibility.Visible;
                        ErrorMSG.Text = $"Errori tuli: {ex.Message}";
                        ValidBox.Visibility = Visibility.Collapsed;
                    }
                }
                else
                {
                    ErrorBox.Visibility = Visibility.Visible;
                    ErrorMSG.Text = "Login failas, koita myöhemmin uudelleen.";
                    ValidBox.Visibility = Visibility.Collapsed;
                }
            }
            else
